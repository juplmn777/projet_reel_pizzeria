...
<nav>
  <div class="nav-left">
    <ul>
      <li><a href="../ourspecials.php"><i class="fas fa-angle-left"></i></a></li>
    </ul>
  </div>
  ...
  <div class="nav-right">
    <ul>
      <li><i clas<li><a href="tel:+33618407576"><i class="fas fa-phone fa-flip-horizontal"></i></a></li>
...
<div class="pizza_picture">
  <img src="../img/specials/mamijo.jpg">
</div>
<div class="pizza_title">
  <div class="pizza_composition">
    <p>Crème fraîche, Saumon frais, Poireaux, Pesto, Mozzarella, Vinaigre balsamique</p>
  </div>
...
<div id="order_pizza">
  <form action="mamijo.php" method="post">
