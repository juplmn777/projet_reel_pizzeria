...
<div class="pizza_picture">
  <img src="../img/specials/lilipizz.jpg">
</div>
<div class="pizza_title">
  <div class="pizza_composition">
    <p>Crème, Moutarde à l’ancienne, Émincés de poulet, Fromage, Ail et fines herbes, Cheddar, Mozzarella, Oeuf de Plein Air, Oignons frits</p>
  </div>
...
<div id="order_pizza">
  <form action="lilipizz.php" method="post">
