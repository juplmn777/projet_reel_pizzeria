...
<div class="pizza_picture">
  <img src="../img/pizzas/4fromageres.jpg">
</div>
<div class="pizza_title">
  <div class="pizza_composition">
    <p>Sauce Tomate, Chèvre, Roquefort AOC, Emmental, Mozzarella</p>
  </div>
...
<div id="order_pizza">
  <form action="4fromageres.php" method="post">
