...
<div class="pizza_picture">
  <img src="../img/pizzas/biquette.jpg">
</div>
<div class="pizza_title">
  <div class="pizza_composition">
    <p>Crème Fraîche, Lardons, Chèvre, Sauce Tomate, Jambon Supérieur, Champignons Frais, Mozzarella</p>
  </div>
...
<div id="order_pizza">
  <form action="biquette.php" method="post">
