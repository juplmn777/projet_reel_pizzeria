...
<div class="pizza_picture">
  <img src="../img/pizzas/bolognaise.jpg">
</div>
<div class="pizza_title">
  <div class="pizza_composition">
    <p>Sauce Bolognaise, Tagliatelles, Boeuf Haché VBF, Mozzarella</p>
  </div>
...
<div id="order_pizza">
  <form action="bolognaise.php" method="post">
