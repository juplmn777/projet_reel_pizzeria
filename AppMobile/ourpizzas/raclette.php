...
<div class="pizza_picture">
  <img src="../img/pizzas/raclette.jpg">
</div>
<div class="pizza_title">
  <div class="pizza_composition">
    <p>Crème Fraîche, Pommes de Terre, Lardons, Raclette, Mozzarella, Jambon Cru Italien, Cornichons</p>
  </div>
...
<div id="order_pizza">
  <form action="raclette.php" method="post">
