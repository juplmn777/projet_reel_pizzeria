...
<div class="pizza_picture">
  <img src="../img/pizzas/montagnarde.jpg">
</div>
<div class="pizza_title">
  <div class="pizza_composition">
    <p>Crème Fraîche, Jambon Supérieur, Pommes de Terre, Reblochon AOP, Mozzarella</p>
  </div>
...
<div id="order_pizza">
  <form action="montagnarde.php" method="post">
