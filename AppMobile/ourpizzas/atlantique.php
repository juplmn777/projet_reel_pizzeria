...
<div class="pizza_picture">
  <img src="../img/pizzas/atlantique.jpg">
</div>
<div class="pizza_title">
  <div class="pizza_composition">
    <p>Crème Fraîche, Mozzarella, Saumon Fumé, Citron, Roquette, Crème de Balsamique</p>
  </div>
...
<div id="order_pizza">
  <form action="atlantique.php" method="post">
