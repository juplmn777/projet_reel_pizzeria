...
<div class="pizza_title">
  <h2>La Flammekueche</h2>
</div>

<div class="pizza_container">
<div class="pizza_picture">
  <img src="../img/pizzas/flammekueche.jpg">
</div>
<div class="pizza_title">
  <div class="pizza_composition">
    <p>Crème Fraîche, Lardons, Oignons Rouges, Mozzarella</p>
  </div>
...
<div id="order_pizza">
  <form action="flammekueche.php" method="post">
