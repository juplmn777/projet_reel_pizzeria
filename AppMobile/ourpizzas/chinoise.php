...
<div class="pizza_picture">
  <img src="../img/pizzas/chinoise.jpg">
</div>
<div class="pizza_title">
  <div class="pizza_composition">
    <p>Sauce Soja, Boeuf Haché VBF, Oignons Rouges, Nouilles Chinoises, Mozzarella</p>
  </div>
...
<div id="order_pizza">
  <form action="chinoise.php" method="post">
