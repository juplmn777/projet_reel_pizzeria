...
<nav>
  <div class="nav-left">
    <ul>
      <li><a href="../ourhotsalads.php"><i class="fas fa-angle-left"></i></a></li>
    </ul>
  </div>
...
<div class="pizza_picture">
  <img src="../img/hotsalads/perigourdine.jpg">
</div>
<div class="pizza_title">
  <div class="pizza_composition">
    <p>Salade, Tomates, Croûtons, Lardons, Gésiers, Oignons Frits, Pépites de Foie Gras</p>
  </div>
...
<div id="order_pizza">
  <form action="perigourdine.php" method="post">
