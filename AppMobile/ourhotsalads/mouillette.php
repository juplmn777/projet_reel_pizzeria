...
<div class="pizza_picture">
  <img src="../img/hotsalads/mouillette.jpg">
</div>
<div class="pizza_title">
  <div class="pizza_composition">
    <p>Salade, Tomates, Croûtons, Lardons, Oeuf Mollet, Jambon Cru Italien, Oignons Frits</p>
  </div>
...
<div id="order_pizza">
  <form action="mouillette.php" method="post">
