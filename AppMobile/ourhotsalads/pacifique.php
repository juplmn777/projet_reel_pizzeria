...
<div class="pizza_picture">
  <img src="../img/hotsalads/pacifique.jpg">
</div>
<div class="pizza_title">
  <div class="pizza_composition">
    <p>Salade, Tomates, Croûtons, Saumon Fumé, Oignons Frits, Citron</p>
  </div>
...
<div id="order_pizza">
  <form action="pacifique.php" method="post">
