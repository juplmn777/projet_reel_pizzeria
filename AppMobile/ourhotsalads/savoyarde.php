...
<div class="pizza_picture">
  <img src="../img/hotsalads/savoyarde.jpg">
</div>
<div class="pizza_title">
  <div class="pizza_composition">
    <p>Salade, Tomates, Croûtons, Lardons, Bacons, Raclette, Oigons Frits</p>
  </div>
...
<div id="order_pizza">
  <form action="savoyarde.php" method="post">
